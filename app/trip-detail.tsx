...
export default function TripDetail() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const disclaimerBox = `
        <div style="border:1px solid #60a5fa;border-radius:6px;padding:8px 12px;margin-top:10px;font-size:11px;color:#334155;line-height:1.55;page-break-inside:avoid;break-inside:avoid">
      ...
      {generatingPDF && (
        <View className="absolute inset-0 z-50 items-center justify-center bg-white/95">
          <View className="items-center">
            ...
            <ActivityIndicator size="large" color="#1976D2" />
            <Text className="mt-4 text-lg font-semibold text-gray-800">Generating PDF...</Text>
